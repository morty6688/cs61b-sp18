...
public class Tileset {
        ...
        public static final TETile YELLOWFLOOR = new TETile('·', new Color(128, 192, 128), Color.yellow, "floor");
        public static final TETile REDFLOOR = new TETile('·', new Color(128, 192, 128), Color.red, "floor");
